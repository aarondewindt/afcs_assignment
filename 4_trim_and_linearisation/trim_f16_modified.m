function [trim_state, trim_thrust, trim_control, dLEF, xu, cost] ...
    = trim_f16_modified(thrust, elevator, alpha, ail, rud, vel, alt, iter, FC_flag)
%================================================
...
% Modified to add the flight condition flag and number iterations 
% as function arguments and prevent display output.
